...
class Main {
    public static void main(String[] args) {
        ...
        Lokasyon nereden = new Lokasyon("Türkiye", "Trabzon", "Trabzon Havalimanı", Durum.Aktif);
        Lokasyon nereye = new Lokasyon("Türkiye", "Antalya", "Antalya Havaalanı", Durum.Aktif);
        LocalDate tarih = LocalDate.of(2023, 4, 12);
        byte koltukSayisi = 2;
